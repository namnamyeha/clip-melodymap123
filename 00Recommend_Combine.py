...
with open("combined_features.json", "r", encoding='utf-8') as file:
...
def recommend_region(choice_embed, place_features):
    ...
    for place in place_features:
        ...
        region_features = place['features']
...
# 결과를 JSON 파일로 저장
with open('con_recommendation_results.json', 'w', encoding='utf-8') as file:
